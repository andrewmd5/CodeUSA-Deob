...
final class Class98_Sub1 extends Class98 {
	...
	static final Class43 method945(final int i, final ha var_ha,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ah.C(" + i + ','
	...
	static final void method946(final int i, final int i_1_, final int i_2_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ah.B(" + i + ','
					+ i_1_ + ',' + i_2_ + ','
					+ (class293 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	Class98_Sub1(final int i, final byte[] is) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ah.<init>(" + i
					+ ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
}
