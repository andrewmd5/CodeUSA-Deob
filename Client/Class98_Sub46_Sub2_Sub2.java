/* Class98_Sub46_Sub2_Sub2 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Class98_Sub46_Sub2_Sub2 extends Class98_Sub46_Sub2 {
	private Object anObject6294;
	static int anInt6295;
	static Class197 aClass197_6296;
	private static short[][] aShortArrayArray6297 = {
			...
			{ 9104, 10275, 7595, 3610, 7975, 8526, 918, -26734, 24466, 10145,
					-6882, 5027, 1457, 16565, -30545, 25486, 24, 5392, 10429,
					3673, -27335, -21957, 192, 687, 412, 21821, 28835, -15460,
					-14019, 7072, 3990, 309, 910, 9509, 9117, 3600, 16442,
					-32601, 22020, 2694, -22264, 10281, 3869, -28007, 10764,
					8974, 3745, 10269, 914, 8629, -26438, 26779, -15208, 8728,
					2982, -25718, 918, 6842, -25030, -5462, -14833, -22386, 8,
					-22468, -27479, -11237, 21664, 45, -24054, -27207, -22887,
					-30051, 20003, 21584, -31426, 28990, -11219, 6353, -25560,
					-25458, -14182, -11006, -27365, 3241, 7457, 8899, 13760,
					4565, 11711, 10436, 8103, 2604, 13740, -28232, -26333,
					-23910, -31403, -32352, -29812, -29909, -24137, 925, 1181,
					3865, 6049, 8582, 1804, 4887, -5372, 15011, 20785, 7591,
					9528, 21770, 14094, 6930, 14635, 5911, 6463, 10124, 17935,
					3218, 262, 5413, -27579, -25189, -26331, -28236, -28144,
					-23804, -23261, -23013, -19045, 5419, 6332, 5665, 2450,
					3617, 8638, 5178, 10374, 6819, 7434, 150, 2446, 9647,
					...
					28967, -25290, 30866, 13466, -28403, -24022, -14042,
			...
			{ 25485, 9105, 10275, 7595, 3610, 7975, 8526, 918, -26734, 24466,
					10145, -6882, 5027, 1457, 16565, -30545, 24, 5392, 10429,
					3673, -27335, -21957, 192, 687, 412, 21821, 28835, -15460,
					-14019, 7072, 3990, 309, 910, 9509, 9117, 3600, 16442,
					-32601, 22020, 2694, -22264, 10281, 3869, -28007, 10764,
					8974, 3745, 10269, 914, 8629, -26438, 26779, -15208, 8728,
			...
			{ 4620, 11140, 6433, 6, 4752, 10264, 7072, 3990, 309, 910, 9509,
					9117, 3600, 16442, -32601, 22020, 2694, -22264, 10281,
					3869, -28007, 10764, 8974, 3745, 10269, 914, 8629, -26438,
					26779, -15208, 8728, 2982, -25718, 918, 6842, -25030,
					-5462, -14833, -22386, 8, -22468, -27479, -11237, 21664,
					45, -24054, -27207, -22887, -30051, 20003, 21584, -31426,
					28990, -11219, 6353, -25560, -25458, -14182, -11006,
					-27365, 3241, 7457, 8899, 13760, 4565, 11711, 10436, 8103,
					2604, 13740, -28232, -26333, -23910, -31403, -32352,
					-29812, -29909, -24137, 925, 1181, 3865, 6049, 8582, 1804,
					4887, -5372, 15011, 20785, 7591, 9528, 21770, 14094, 6930,
					14635, 5911, 6463, 10124, 17935, 3218, 262, 5413, -27579,
					-25189, -26331, -28236, -28144, -23804, -23261, -23013,
					-19045, 5419, 6332, 5665, 2450, 3617, 8638, 5178, 10374,
					6819, 7434, 150, 2446, 9647, -27504, -27586, -31695, 11142,
					18704, 10775, 21898, 10554, 9492, 11811, 11140, -15978,
					-24180, -32498, -29288, 29084, -9579, -18799, -27122, 913,
					6024, 2966, -5238, 6542, 15240, 10, 39, 3986, 2324, 6030,
					-31709, 512, 33, 9394, -4833, 28967, -25290, 30866, 13466,
					-28403, -24022, -14042, -22472, -18166, 20493, -27626,
					-22266, -1784, -31473, 9612, 7324, 646, 778, 786, 800,
					-624, -3198, -8164, 1678, 29068, 22412, -32253, 29075,
			...
			{ 4540, 4529, 5674, 5667, 5785, 6802, 8072, 4562, 4437, 4317, 5896,
					4488 } };
	static s[] aSArray6298;
	static short[][][] aShortArrayArrayArray6299;
	static int anInt6300;
	private static short[][] aShortArrayArray6301;
	static Class98_Sub11[] aClass98_Sub11Array6302;
	private static short[][] aShortArrayArray6303;
	...
	static final int method1537(final int i, final int i_0_) {
		try {
			int i_1_;
			if ((i ^ 0xffffffff) < -12001) {
				...
				if ((i ^ 0xffffffff) < -2001) {
					...
					Class98_Sub32.method1436(-119, true);
					i_1_ = 1;
				}
			} else {
	...
	static final int method1538(final int i, final int i_2_, final int i_3_,
			final int i_4_) {
		try {
			if (i_4_ != 24111) {
				method1538(113, -34, 119, -107);
			}
			if (Class78.aSArray594 == null) {
				return 0;
			}
			final int i_5_ = i_3_ >> 1350900553;
			final int i_6_ = i_2_ >> 1039231433;
			if (i_5_ < 0
					|| (i_6_ ^ 0xffffffff) > -1
					|| -1 + Class165.anInt1276 < i_5_
					|| ((-1 + Class98_Sub10_Sub7.anInt5572 ^ 0xffffffff) > (i_6_ ^ 0xffffffff))) {
				return 0;
			}
			int i_7_ = i;
			if (i_7_ < 3
					&& (Class281.aByteArrayArrayArray2117[1][i_5_][i_6_] & 0x2 ^ 0xffffffff) != -1) {
				i_7_++;
			}
	...
	Class98_Sub46_Sub2_Sub2(final Object object, final int i) {
		super(i);
		try {
			anObject6294 = object;
		} catch (final RuntimeException runtimeexception) {
	...
	public static void method1539(final int i) {
		try {
			aShortArrayArray6301 = null;
			aSArray6298 = null;
			aClass98_Sub11Array6302 = null;
			aShortArrayArrayArray6299 = null;
			aClass197_6296 = null;
			if (i != 22412) {
				method1538(-84, -71, -63, 112);
			}
	...
	static {
		anInt6295 = 0;
		aClass98_Sub11Array6302 = new Class98_Sub11[300];
		aShortArrayArray6301 = (new short[][] {
				...
				{ 4550, 4537, 5681, 5673, 5790, 6806, 8076, 4574, 4444, 4328,
						7052, 4490 } });
		aShortArrayArray6303 = new short[][] { new short[0], new short[0],
				new short[0], new short[0], new short[0] };
		aShortArrayArrayArray6299 = new short[][][] { aShortArrayArray6301,
				aShortArrayArray6297, aShortArrayArray6303 };
	}
}
