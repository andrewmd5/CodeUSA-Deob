...
final class Class98_Sub10_Sub9 extends Class98_Sub10 {
	...
	private final void method1031(final int i) {
		while_78_: do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "et.H(" + i
						+ ')');
			}
		} while (false);
	}
	...
	static final int method1032(final int i, final byte i_31_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "et.D(" + i + ','
					+ i_31_ + ')');
		}
	}
	...
	final int[] method990(final int i, final int i_32_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "et.G(" + i + ','
					+ i_32_ + ')');
		}
	}
	...
	static final boolean method1033(final int i, final int i_36_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("et.B(" + i + ','
					+ i_36_ + ',' + i_37_ + ')'));
		}
	}
	...
	private final void method1034(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "et.F(" + i + ')');
		}
	}
	...
	private final int[] method1035(final int i, final int i_41_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "et.J(" + i + ','
					+ i_41_ + ')');
		}
	}
	...
	final void method1001(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "et.I(" + i + ')');
		}
	}
	...
	static final void method1036(final int i, final int i_42_, final int i_43_,
		...
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, ("et.E(" + i
	...
	final void method991(final int i, final ByteBuffer class98_sub22,
		...
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, ("et.A(" + i
