...
final class Class98_Sub46_Sub11 extends Class98_Sub46 {
	...
	final String method1576(final int i, final ByteBuffer class98_sub22) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("gj.G(" + i + ','
	...
	final void method1579(final ByteBuffer class98_sub22, final int[] is,
		...
		while_93_: do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("gj.C("
						+ (class98_sub22 != null ? "{...}" : "null") + ','
						+ (is != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
	...
	final Class348 method1580(final int i, final int i_11_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "gj.F(" + i + ','
					+ i_11_ + ')');
		}
	}
	...
	static final Class98_Sub10 method1581(final byte i,
		...
		try {
			...
			final Class98_Sub10 class98_sub10 = Class313.method3630(i_13_, 115);
			...
			throw Class64_Sub27.method667(runtimeexception, ("gj.O(" + i + ','
					+ (class98_sub22 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final int method1583(final int i, final int i_17_, final int i_18_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("gj.A(" + i + ','
					+ i_17_ + ',' + i_18_ + ')'));
		}
	}
	...
	final void method1584(final byte i, final ByteBuffer class98_sub22) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("gj.B(" + i + ','
					+ (class98_sub22 != null ? "{...}" : "null") + ')'));
		}
	}
