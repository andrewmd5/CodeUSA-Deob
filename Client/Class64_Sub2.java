...
final class Class64_Sub2 extends Class64 {
	...
	static final void method559(final boolean bool, final int i, final int i_0_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("av.H(" + bool
						+ ',' + i + ',' + i_0_ + ')'));
			}
			break;
		} while (false);
	...
	static final int method561(final byte i, final int i_3_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "av.I(" + i + ','
					+ i_3_ + ')');
		}
	}
	...
	final void method550(final int i, final int i_21_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "av.B(" + i + ','
					+ i_21_ + ')');
		}
	}
	...
	final int method556(final int i, final int i_23_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "av.F(" + i + ','
					+ i_23_ + ')');
		}
	}
}
