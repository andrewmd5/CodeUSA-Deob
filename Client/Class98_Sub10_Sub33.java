...
final class Class98_Sub10_Sub33 extends Class98_Sub10 {
	...
	final int[][] method997(final int i, final int i_0_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "sg.C(" + i + ','
					+ i_0_ + ')');
		}
	}
	...
	static final void method1099(final int i, final int i_7_, final byte i_8_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("sg.D(" + i + ','
					+ i_7_ + ',' + i_8_ + ')'));
		}
	}
	...
	final void method1001(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "sg.I(" + i + ')');
		}
	}
	...
	private final void method1100(final int i, final int i_9_) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "sg.E(" + i
						+ ',' + i_9_ + ')');
			}
			break;
		} while (false);
	...
	static final int method1101(final int i, final Class207 class207) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("sg.B(" + i + ','
					+ (class207 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	private final void method1102(final int i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "sg.F(" + i
						+ ')');
			}
			break;
		} while (false);
