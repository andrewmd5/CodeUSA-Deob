...
final class Class134_Sub1 extends Class134 {
	...
	static final byte[] method2244(final int i, final float f,
			final float f_0_, final float f_1_, final int i_2_, final int i_3_,
			final int i_4_, final Class39 class39, final float f_5_,
			final float f_6_, final int i_7_) {
		try {
			final byte[] is = new byte[i_2_ * i_4_ * i_7_];
			Class98_Sub48.method1661(0, i_2_, class39, (byte) -19, f, f_1_,
					i_4_, f_5_, i_7_, i_3_, f_0_, is, f_6_);
			if (i != -31633) {
	...
	public final void method60(final boolean bool, final byte i) {
		try {
			final int i_8_ = ((((Class134) this).aClass337_3460.aClass63_3538
					.method545(Class98_Sub17_Sub1.anInt5782,
							((Class134) this).aClass332_3459.method3737(),
							(byte) -106)) + ((Class134) this).aClass337_3460.anInt3541);
			final int i_9_ = ((((Class134) this).aClass337_3460.aClass110_3540
					.method2088(((Class134) this).aClass332_3459.method3749(),
							Class246_Sub2.anInt5072, (byte) -56)) + ((Class134) this).aClass337_3460.anInt3542);
			if (i >= -81) {
				anInt5459 = 121;
			}
			((Class134) this).aClass332_3459.method3730(i_8_
					+ ((Class134) this).aClass332_3459.method3737() / 2,
					((Class134) this).aClass332_3459.method3749() / 2 + i_9_,
					4096, anInt5458);
	...
	static final boolean method2245(final int i, final char c) {
		try {
			if (i != 18646) {
				anInt5459 = -5;
			}
	...
	static final boolean method2246(final String string, final byte i) {
		try {
			if (i != -36) {
				return true;
			}
	...
	static final void method2247(final int i) {
		try {
			...
			Class98_Sub22_Sub2.aFloat5794 = 0x3fff
					& (int) (Math.random() * 160.0) + -80;
			...
			for (int i_12_ = 0; i_12_ < 2048; i_12_++) {
				Class151_Sub9.aClass246_Sub3_Sub4_Sub2_Sub2Array5030[i_12_] = null;
			}
			...
			for (int i_13_ = 0; i_13_ < Class76_Sub5.anIntArray3744.length; i_13_++) {
				if (!Class140.aBooleanArray3246[i_13_]) {
			...
			for (Class98_Sub18 class98_sub18 = (Class98_Sub18) Class116.aClass377_964
					.method3998(113); class98_sub18 != null; class98_sub18 = (Class98_Sub18) Class116.aClass377_964
					.method3995(-1)) {
			...
			for (int i_17_ = 0; (i_17_ ^ 0xffffffff) > -26; i_17_++) {
				Class64_Sub21.skillLevels[i_17_] = 0;
			...
			Class218.aString1636 = Class309.aClass309_2612.method3615(
	...
	Class134_Sub1(final Class207 class207, final Class337_Sub1 class337_sub1) {
		super(class207, class337_sub1);
	}

	/* synthetic */
	static Class method2248(final String string) {
		try {
