...
final class Class64_Sub29 extends Class64 {
	...
	static final void method673(final ha var_ha, final d var_d, final int i,
		...
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("wfa.G("
						+ (var_ha != null ? "{...}" : "null") + ','
						+ (var_d != null ? "{...}" : "null") + ',' + i + ','
						+ i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ')'));
			}
	...
	final void method550(final int i, final int i_16_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "wfa.B(" + i + ','
					+ i_16_ + ')');
		}
	}
	...
	static final void method674(final int i, final int i_18_, final int i_19_,
		...
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("wfa.D(" + i
						+ ',' + i_18_ + ',' + i_19_ + ','
	...
	static final String method675(final int i, final int i_23_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "wfa.H(" + i + ','
					+ i_23_ + ')');
		}
	}
	...
	final int method556(final int i, final int i_25_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "wfa.F(" + i + ','
					+ i_25_ + ')');
		}
	}
