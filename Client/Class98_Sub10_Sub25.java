...
final class Class98_Sub10_Sub25 extends Class98_Sub10 {
	...
	final int method992(final int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "om.S(" + i + ')');
		}
	}
	...
	static final void method1080(final byte i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "om.E(" + i + ')');
		}
	}
	...
	final void method993(final int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "om.P(" + i + ')');
		}
	}
	...
	final void method998(final int i, final int i_3_, final int i_4_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("om.O(" + i
						+ ',' + i_3_ + ',' + i_4_ + ')'));
			}
			break;
		} while (false);
	...
	static final void method1081(final int i,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("om.D(" + i + ','
	...
	final int[][] method997(final int i, final int i_13_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "om.C(" + i + ','
					+ i_13_ + ')');
		}
	}
}
