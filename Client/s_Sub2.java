...
final class s_Sub2 extends s {
		...
		try {
			if (aClass98_Sub30Array5246 != null) {
				...
				if (!aClass148_5231.method2420(-124)) {
					...
					for (Class98 class98 = aClass148_5231.method2418(32); class98 != null; class98 = aClass148_5231
							.method2417(119)) {
						final Class98_Sub25 class98_sub25 = (Class98_Sub25) class98;
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.A(" + i + ','
					+ i_0_ + ',' + i_1_ + ',' + bool + ','
						...
						if ((anIntArrayArrayArray5241[i_24_][i_25_]) != null) {
							...
							for (int i_52_ = 0; ((is_30_.length ^ 0xffffffff) < (i_52_ ^ 0xffffffff)); i_52_++) {
								...
								if (class98 == null) {
									...
									is_51_[i_52_] = ((Class98_Sub40) class98).aShort4191;
									i_79_ = 0xffff & is_51_[i_52_];
									if ((i_57_ ^ 0xffffffff) != 0
											&& (((Class98) (class98_sub30s_26_[i_52_])).aLong832 < ((Class98) (class98_sub30s_21_[i_79_])).aLong832)) {
										class98_sub30s_21_[i_79_] = class98_sub30s_26_[i_52_];
									}
								}
							...
							while (is_90_.length > i_92_) {
								...
								if (class98_sub30_96_ != null) {
									...
									if (class98_sub30_98_ == null
											|| ((((Class98) class98_sub30_96_).aLong832) < (((Class98) class98_sub30_98_).aLong832))) {
								...
								if (class98_sub30_97_ != null) {
									class98_sub30_97_.method1315(i_91_, -20787,
											i_88_, i_89_);
									if (class98_sub30_98_ == null
											|| ((((Class98) class98_sub30_97_).aLong832) < (((Class98) class98_sub30_98_).aLong832))) {
	...
	final void ka(final int i, final int i_102_, final int i_103_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("si.ka(" + i
						+ ',' + i_102_ + ',' + i_103_ + ')'));
			}
			break;
		} while (false);
	...
	final r fa(final int i, final int i_104_, final r var_r) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.fa(" + i + ','
	...
	final void method3424(final int i, final int i_107_, final int[] is,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.H(" + i + ','
					+ i_107_ + ',' + (is != null ? "{...}" : "null") + ','
					+ (is_108_ != null ? "{...}" : "null") + ','
					+ (is_109_ != null ? "{...}" : "null") + ','
					+ (is_110_ != null ? "{...}" : "null") + ','
	...
	final void CA(final r var_r, final int i, final int i_135_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.CA("
					+ (var_r != null ? "{...}" : "null") + ',' + i + ','
	...
	final void method3422(final int i, final int i_140_, final int i_141_,
		...
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("si.F(" + i
	...
	final void wa(final r var_r, final int i, final int i_160_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.wa("
					+ (var_r != null ? "{...}" : "null") + ',' + i + ','
	...
	final boolean method3418(final r var_r, final int i, final int i_165_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.O("
					+ (var_r != null ? "{...}" : "null") + ',' + i + ','
	...
	private final void method3436(final boolean bool, final int i,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.B(" + bool
					+ ',' + i + ',' + i_170_ + ','
	...
	final void method3421(final Class98_Sub5 class98_sub5, final int[] is) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.K("
	...
	final void method3426(final int i, final int i_191_, final int i_192_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.C(" + i + ','
					+ i_191_ + ',' + i_192_ + ','
	...
	final void U(final int i, final int i_195_, final int[] is,
		...
		try {
			...
			for (int i_206_ = 0; i_206_ < is_199_.length; i_206_++) {
				...
				Class98 class98;
				for (class98 = aClass377_5247.method3990(l, -1); class98 != null; class98 = aClass377_5247
						.method3993(-95)) {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.U(" + i + ','
					+ i_195_ + ',' + (is != null ? "{...}" : "null") + ','
					+ (is_196_ != null ? "{...}" : "null") + ','
					+ (is_197_ != null ? "{...}" : "null") + ','
					+ (is_198_ != null ? "{...}" : "null") + ','
	...
	final void method3416(final int i, final int i_209_, final int i_210_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("si.N(" + i + ','
					+ i_209_ + ',' + i_210_ + ','
					+ (bools != null ? "{...}" : "null") + ',' + bool + ','
					+ i_211_ + ',' + i_212_ + ')'));
		}
