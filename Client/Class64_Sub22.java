...
final class Class64_Sub22 extends Class64 {
	...
	static final void method640(final double d, final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "rv.H(" + d + ','
					+ i + ')');
		}
	}
	...
	final int method641(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "rv.E(" + i + ')');
		}
	}
	...
	final void method551(final byte i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "rv.C(" + i
						+ ')');
			}
			break;
		} while (false);
	...
	public static void method642(final int i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "rv.I(" + i
						+ ')');
			}
			break;
		} while (false);
	...
	final void method550(final int i, final int i_2_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "rv.B(" + i + ','
					+ i_2_ + ')');
		}
	}
	...
	static final void method643(final int i, final Class213 class213) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("rv.D(" + i + ','
					+ (class213 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method644(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "rv.G(" + i + ')');
		}
	}
	...
	static final void method645(final byte i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "rv.M(" + i
						+ ')');
			}
			break;
		} while (false);
	...
	final int method552(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "rv.A(" + i + ')');
		}
	}
	...
	final int method556(final int i, final int i_43_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "rv.F(" + i + ','
					+ i_43_ + ')');
		}
	}
}
