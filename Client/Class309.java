...
final class Class309 {
	static Class309 aClass309_2586 = (new Class309(
	...
	static Class309 aClass309_2587 = (new Class309(
	...
	static Class309 aClass309_2589 = new Class309(
			"Unknown developer command: ", "Unbekannter Befehl: ",
			"Commande inconnue : ", "Comando desconhecido: ");
	static Class309 aClass309_2590 = new Class309("Cancel", "Abbrechen",
			"Annuler", "Cancelar");
	static Class309 MEMBERS_OBJECT;
	...
	static final void method3614(final boolean bool, final int i) {
		do {
			try {
				...
				for (Class98_Sub42 class98_sub42 = ((Class98_Sub42) Class358.aClass148_3032
					...
					class98_sub42.method942(57);
				}
				for (Class98_Sub42 class98_sub42 = (Class98_Sub42) Class98_Sub10_Sub14.aClass377_5612
						.method3998(118); class98_sub42 != null; class98_sub42 = (Class98_Sub42) Class98_Sub10_Sub14.aClass377_5612
						.method3995(-1)) {
					if ((class98_sub42.aClass98_Sub31_Sub5_4232) != null) {
						Class81.aClass98_Sub31_Sub3_619
								.method1374(class98_sub42.aClass98_Sub31_Sub5_4232);
	...
	final String method3615(final int i, final byte i_1_) {
		try {
			if (i_1_ != 25) {
				return null;
			}
	...
	private Class309(final String string, final String string_2_,
			final String string_3_, final String string_4_) {
		try {
	...
	public static void method3616(final int i) {
		try {
			aClass309_2598 = null;
			aClass309_2641 = null;
			aClass309_2586 = null;
	...
	static {
		...
		MEMBERS_OBJECT = new Class309("Members object",
				"Gegenstand f\u00fcr Mitglieder", "Objet d'abonn\u00e9s",
				"Objeto para membros");
		new Class309(
		...
		aClass309_2592 = new Class309("Discard", "Ablegen", "Jeter",
				"Descartar");
		aClass309_2593 = new Class309("Take", "Nehmen", "Prendre", "Pegar");
		aClass309_2594 = new Class309("Drop", "Fallen lassen", "Poser",
				"Largar");
		new Class309("Ok", "Okay", "OK", "Ok");
		new Class309("Select", "Ausw\u00e4hlen", "S\u00e9lectionner",
				"Selecionar");
		aClass309_2595 = new Class309("Continue", "Weiter", "Continuer",
				"Continuar");
		new Class309("Invalid player name.",
				"Unzul\u00e4ssiger Charaktername!", "Nom de joueur incorrect.",
				"Nome de jogador inv\u00e1lido.");
		new Class309("You can't report yourself!",
		...
		new Class309(null, "Dieses System darf nicht missbraucht werden!",
				null, null);
		new Class309(
				"You cannot report that person for Staff Impersonation, they are CodeUSA Staff.",
				"Diese Person ist ein CodeUSA-Mitarbeiter!",
				"Cette personne est un membre du personnel de CodeUSA, vous ne pouvez pas la signaler pour abus d'identit\u00e9.",
				"Voc\u00ea n\u00e3o pode denunciar essa pessoa por tentar se passar por membro da equipe CodeUSA, pois ela faz parte da equipe.");
		new Class309(
				"You can spot a CodeUSA moderator by the gold crown next to their name.",
				"CodeUSA-Mitarbeiter haben eine goldene Krone neben ihrem Namen.",
				"Vous pouvez reconna\u00eetre les mod\u00e9rateurs CodeUSA \u00e0 la couronne dor\u00e9e en regard de leur nom.",
				"Os moderadores da CodeUSA s\u00e3o identificados por uma coroa dourada pr\u00f3xima ao \u007fnome.");
		new Class309(
		...
		new Class309("Thank-you, your abuse report has been received.",
		...
		new Class309("Invalid name", "Unzul\u00e4ssiger Name!",
		...
		new Class309("Unable to delete name - system busy.",
		...
		new Class309(null, "der Spieler ist momentan nicht verf\u00fcgbar.",
				null, null);
		new Class309(
		...
		new Class309(null, "Spieler nicht auf deiner Freunde-Liste.", null,
				null);
		new Class309(
		...
		new Class309("Chat disabled", "Deaktiviert",
				"Messagerie d\u00e9sactiv\u00e9e", "Bate-papo desativado");
		new Class309("guild_chat", "guildchat", "conversation_guild",
				"guild_chat");
		new Class309("You are not currently in a clan channel.",
		...
		new Class309("Invalid channel name entered!",
		...
		new Class309("Now talking in clan channel ", "Chatraum: ",
				"Vous participez actuellement au canal de clan ",
				"Falando no canal do cl\u00e3 agora ");
		new Class309("Now talking in clan channel of player: ",
		...
		new Class309("The channel you tried to join does not exist.",
		...
		new Class309("You are temporarily banned from this clan channel.",
		...
		new Class309("Your clan channel has now been disabled!",
		...
		new Class309("That user is not in this channel.",
		...
		new Class309("This mute will remain for a further ",
		...
		aClass309_2598 = new Class309("Loading...",
				"Ladevorgang - bitte warte.",
				"Chargement en cours. Veuillez patienter.",
				"Carregando. Aguarde.");
		aClass309_2599 = new Class309("Scaning Hardware", "Profiling...",
				"Profilage...", "Profiling...");
		aClass309_2600 = new Class309("Connection dropped.",
				"Verbindung abgebrochen.", "Connexion perdue.",
				"Conex\u00e3o perdida.");
		aClass309_2601 = (new Class309(
		...
		aClass309_2602 = new Class309("Viewing Change Log.. - ",
				"Suche nach Updates - ",
		...
		new Class309(null,
				...
				null, null);
		new Class309("Server Update In: ", "Server-Update In: ",
				"Mise \u00e0 jour syst\u00e8me dans : ",
				"Atualiza\u00e7\u00e3o do sistema em: ");
		aClass309_2605 = new Class309(" is now online.", " loggt sich ein.",
				" s'est connect\u00e9.", " entrou no jogo.");
		aClass309_2606 = new Class309(" is now offline.", " loggt sich aus.",
				" s'est d\u00e9connect\u00e9.", " saiu do jogo.");
		aClass309_2607 = new Class309("Unable to find ",
				"Spieler kann nicht gefunden werden: ",
				"Impossible de trouver ",
				"N\u00e3o \u00e9 poss\u00edvel encontrar ");
		new Class309("Use", "Benutzen", "Utiliser", "Usar");
		aClass309_2608 = new Class309("Examine", "Untersuchen", "Examiner",
				"Examinar");
		aClass309_2609 = new Class309("Attack", "Angreifen", "Attaquer",
				"Atacar");
		aClass309_2610 = new Class309("Choose Option", "W\u00e4hl eine Option",
				"Choisir une option", "Selecionar op\u00e7\u00e3o");
		aClass309_2611 = new Class309(" more options", " weitere Optionen",
				" autres options", " mais op\u00e7\u00f5es");
		aClass309_2612 = new Class309("Walk here", "Hierhin gehen",
				"Atteindre", "Caminhar para c\u00e1");
		aClass309_2613 = new Class309("Face here", "Hierhin drehen",
				"Regarder dans cette direction", "Virar para c\u00e1");
		aClass309_2614 = new Class309("level: ", "Stufe: ", "niveau ",
				"n\u00edvel: ");
		aClass309_2615 = new Class309("skill: ", "Fertigkeit: ",
				"comp\u00e9tence ", "habilidade: ");
		aClass309_2616 = new Class309("rating: ", "Kampfstufe: ",
				"classement ", "qualifica\u00e7\u00e3o: ");
		aClass309_2617 = new Class309("Please wait...", "Bitte warte...",
		...
		new Class309(
				...
				"Fermez l'interface que vous avez ouverte avant d'utiliser le bouton \u00ab Signaler un abus \u00bb.",
				"Feche a interface aberta antes de usar o recurso \"Denunciar abuso\".");
		aClass309_2618 = new Class309(" ", ": ", " ", " ");
		aClass309_2619 = new Class309("M", "M", "M", "M");
		aClass309_2620 = new Class309("M", "M", "M", "M");
		aClass309_2621 = new Class309("K", "T", "K", "K");
		aClass309_2622 = new Class309("K", "T", "K", "K");
		new Class309("From", "Von:", "De", "De");
		aClass309_2623 = new Class309("Self", "Mich", "Moi", "Eu");
		aClass309_2624 = new Class309(" is already on your friends list.",
				" steht bereits auf deiner Freunde-Liste!",
				" est d\u00e9j\u00e0 dans votre liste d'amis.",
				" j\u00e1 est\u00e1 na sua lista de amigos.");
		aClass309_2625 = (new Class309(
		...
		aClass309_2629 = new Class309("Please remove ", "Bitte entferne ",
				"Veuillez commencer par supprimer ", "Remova ");
		aClass309_2630 = new Class309(" from your ignore list first.",
				" zuerst von deiner Ignorieren-Liste!",
				" de votre liste noire.",
				" da sua lista de ignorados primeiro.");
		aClass309_2631 = new Class309("Please remove ", "Bitte entferne ",
				"Veuillez commencer par supprimer ", "Remova ");
		aClass309_2632 = new Class309(" from your friends list first.",
				" zuerst von deiner Freunde-Liste!", " de votre liste d'amis.",
				" da sua lista de amigos primeiro.");
		aClass309_2633 = new Class309("yellow:", "gelb:", "jaune:", "amarelo:");
		aClass309_2634 = new Class309("red:", "rot:", "rouge:", "vermelho:");
		aClass309_2635 = new Class309("green:", "gr\u00fcn:", "vert:", "verde:");
		aClass309_2636 = new Class309("cyan:", "blaugr\u00fcn:", "cyan:",
				"cyan:");
		aClass309_2637 = new Class309("purple:", "lila:", "violet:", "roxo:");
		aClass309_2638 = new Class309("white:", "weiss:", "blanc:", "branco:");
		aClass309_2639 = new Class309("flash1:", "blinken1:", "clignotant1:",
				"flash1:");
		aClass309_2640 = new Class309("flash2:", "blinken2:", "clignotant2:",
				"flash2:");
		aClass309_2641 = new Class309("flash3:", "blinken3:", "clignotant3:",
				"brilho3:");
		aClass309_2642 = new Class309("glow1:", "leuchten1:", "brillant1:",
				"brilho1:");
		aClass309_2643 = new Class309("glow2:", "leuchten2:", "brillant2:",
				"brilho2:");
		aClass309_2644 = new Class309("glow3:", "leuchten3:", "brillant3:",
				"brilho3:");
		aClass309_2645 = new Class309("wave:", "welle:", "ondulation:", "onda:");
		aClass309_2646 = new Class309("wave2:", "welle2:", "ondulation2:",
				"onda2:");
		aClass309_2647 = new Class309("shake:", "sch\u00fctteln:",
				"tremblement:", "tremor:");
		aClass309_2648 = new Class309("scroll:", "scrollen:",
				"d\u00e9roulement:", "rolagem:");
		aClass309_2649 = new Class309("slide:", "gleiten:", "glissement:",
				"deslizamento:");
