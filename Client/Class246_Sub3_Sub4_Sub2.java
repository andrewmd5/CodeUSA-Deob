...
abstract class Class246_Sub3_Sub4_Sub2 extends Class246_Sub3_Sub4 {
	...
	final void method3032(final int i, final boolean bool, final int i_1_,
		...
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("oi.S(" + i
						+ ',' + bool + ',' + i_1_ + ',' + i_2_ + ',' + i_3_
						+ ',' + i_4_ + ')'));
			}
			break;
	...
	int method3034(final int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "oi.A(" + i + ')');
		}
	}
	...
	final void method3036(final ha var_ha, final boolean bool, final byte i,
			final Class111 class111, final Class146[] class146s) {
		do {
			try {
				if (i <= -118) {
					do {
						...
						final Class146 class146 = class146s[0];
						final Class146 class146_15_ = class146s[1];
						final Class146 class146_16_ = class146s[2];
						if (class146 != null) {
				...
				throw Class64_Sub27.method667(runtimeexception, ("oi.N("
	...
	final void method3037(final int i, final boolean bool, final int i_30_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("oi.V(" + i + ','
	...
	final void method3038(final int[] is, final int[] is_46_, final boolean bool) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("oi.M("
					+ (is != null ? "{...}" : "null") + ','
	...
	final void method3040(final boolean bool, final int i, final int i_50_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("oi.C(" + bool
					+ ',' + i + ',' + i_50_ + ',' + i_51_ + ',' + i_52_ + ','
					+ i_53_ + ')'));
		}
	}
	...
	public Class246_Sub3_Sub4_Sub2() {
		...
		anInt6433 = 0;
		aClass146Array6441 = new Class146[3];
		anInt6435 = 0;
		anInt6436 = 0;
		aBoolean6442 = false;
		aBoolean6440 = false;
	...
	final void method3042(final int i, final int i_96_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "oi.P(" + i + ','
					+ i_96_ + ')');
		}
	}
	...
	final boolean method3043(final int i, final int i_98_, final int i_99_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("oi.K(" + i + ','
					+ i_98_ + ',' + i_99_ + ')'));
		}
	}
	...
	final void method3045(final byte i, final int i_108_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "oi.E(" + i + ','
					+ i_108_ + ')');
		}
	}

	final void method3046(final int i, final Class146 class146) {
		try {
			if (i != 758) {
				anInt6384 = -63;
			}
			...
			if ((i_109_ ^ 0xffffffff) != -1 || (i_110_ ^ 0xffffffff) != -1) {
				final int i_111_ = class146.fa() / 2;
			...
			throw Class64_Sub27.method667(runtimeexception, ("oi.Q(" + i + ','
					+ (class146 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method3047(final int i, final boolean bool, final int i_112_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("oi.W(" + i + ','
					+ bool + ',' + i_112_ + ')'));
		}
	}
