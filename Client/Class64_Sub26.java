...
final class Class64_Sub26 extends Class64 {
	...
	static final int method658(final int i, final int i_0_, final int i_1_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("vd.D(" + i + ','
					+ i_0_ + ',' + i_1_ + ')'));
		}
	}
	...
	final int method552(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "vd.A(" + i + ')');
		}
	}
	...
	public static void method659(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "vd.I(" + i + ')');
		}
	}
	...
	final void method550(final int i, final int i_3_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "vd.B(" + i + ','
					+ i_3_ + ')');
		}
	}
	...
	static final void method660(final int i, final int i_5_, final int i_6_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("vd.H(" + i + ','
					+ i_5_ + ',' + i_6_ + ',' + i_7_ + ')'));
		}
	}
	...
	final boolean method661(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "vd.G(" + i + ')');
		}
	}
	...
	final int method556(final int i, final int i_9_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "vd.F(" + i + ','
					+ i_9_ + ')');
		}
	}
	...
	final int method662(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "vd.E(" + i + ')');
		}
	}
	...
	final void method551(final byte i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "vd.C(" + i
						+ ')');
			}
			break;
		} while (false);
