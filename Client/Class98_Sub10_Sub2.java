...
final class Class98_Sub10_Sub2 extends Class98_Sub10 {
	...
	final int[][] method997(final int i, final int i_0_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "aha.C(" + i + ','
					+ i_0_ + ')');
		}
	}
	...
	static final String method1007(final String string, final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("aha.B("
					+ (string != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	final void method1001(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "aha.I(" + i + ')');
		}
	}
	...
	final int[] method990(final int i, final int i_16_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "aha.G(" + i + ','
					+ i_16_ + ')');
		}
	}
	...
	static final void method1008(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "aha.F(" + i + ')');
		}
	}
	...
	static final void method1009(final int i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "aha.E(" + i
						+ ')');
			}
		} while (false);
	}
	...
	static final Class267 method1010(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "aha.D(" + i + ')');
		}
	}
}
