...
final class Class8 {
	...
	final Class98_Sub46_Sub18 method185(final int i, final int i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ai.D(" + i + ','
					+ i_0_ + ')');
		}
	}
	...
	static final void method186(final int i, final Class293 class293,
		...
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("ai.A(" + i
						+ ',' + (class293 != null ? "{...}" : "null") + ','
						+ i_1_ + ',' + i_2_ + ')'));
			}
			break;
	...
	Class8(final Class279 class279, final int i, final Class207 class207) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ai.<init>("
