...
final class Class83 {
	...
	final Class152 method826(final int i, final int i_17_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "fga.C(" + i + ','
					+ i_17_ + ')');
		}
	}
	...
	final void method827(final byte i, final int i_18_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "fga.G(" + i + ','
					+ i_18_ + ')');
		}
	}
	...
	Class83(final Class279 class279, final int i, final Class207 class207,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("fga.<init>("
