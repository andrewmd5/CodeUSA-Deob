...
final class Class98_Sub16 extends Class98 {
	...
	static final void method1147(final int i, final int i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "hea.E(" + i + ','
					+ i_0_ + ')');
		}
	}
	...
	static final int method1149(final boolean bool, final Class199 class199,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("hea.B(" + bool
					+ ',' + (class199 != null ? "{...}" : "null") + ','
					+ (var_ha != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method1150(final int i, final int i_2_, final int i_3_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("hea.C(" + i + ','
					+ i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + bool + ')'));
		}
	}
}
