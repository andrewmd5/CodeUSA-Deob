...
final class Class98_Sub10_Sub21 extends Class98_Sub10 {
	...
	static final void method1063(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "mba.E(" + i + ')');
		}
	}
	...
	final void method1001(final byte i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "mba.I(" + i
						+ ')');
			}
			break;
		} while (false);
	...
	static final boolean method1064(final int i, final boolean bool) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "mba.D(" + i + ','
					+ bool + ')');
		}
	}
	...
	private final boolean method1065(final byte i, final int i_0_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("mba.F(" + i + ','
					+ i_0_ + ',' + i_1_ + ')'));
		}
	}
	...
	static final void method1066(final int i, final Class293 class293) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("mba.J(" + i + ','
					+ (class293 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	private final boolean method1067(final int i, final int i_5_, final int i_6_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("mba.H(" + i + ','
					+ i_5_ + ',' + i_6_ + ')'));
		}
	}
	...
	final int[] method990(final int i, final int i_9_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "mba.G(" + i + ','
					+ i_9_ + ')');
		}
	}
	...
	final void method991(final int i, final ByteBuffer class98_sub22,
		...
		while_127_: do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, ("mba.A(" + i
	...
	public static void method1068(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "mba.B(" + i + ')');
		}
	}
}
