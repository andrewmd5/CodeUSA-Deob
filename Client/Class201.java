...
final class Class201 {
	...
	static final void method2696(final int i, final Class293 class293,
			final ha var_ha, final int i_0_, final int i_1_) {
		do {
			try {
				final aa var_aa = class293.method3469(var_ha, i + 117);
				if (var_aa != null) {
					var_ha.KA(i_0_, i_1_, class293.anInt2311 + i_0_, i_1_
							+ class293.anInt2258);
					if ((Class333.anInt3386 ^ 0xffffffff) == -3
							|| Class333.anInt3386 == 5
						...
						final int i_6_ = (-(2 * (-104 + Class165.anInt1276))
								+ i_3_ / 128 + 48);
						final int i_7_ = (-(i_5_ / 128) + 48 - (-(Class98_Sub10_Sub7.anInt5572 * 4)
								- -(2 * Class98_Sub10_Sub7.anInt5572) - 208));
						Class64_Sub9.aClass332_3663.method3746(i_0_
								+ (class293.anInt2311) / 2.0F, i_1_
								+ (class293.anInt2258) / 2.0F, i_6_, i_7_,
								i_2_, i_4_ << 1401446114, var_aa, i_0_, i_1_);
						for (Class98_Sub34 class98_sub34 = (Class98_Sub34) Class64_Sub8.aClass148_3659
								.method2418(32); class98_sub34 != null; class98_sub34 = (Class98_Sub34) Class64_Sub8.aClass148_3659
								.method2417(i ^ 0x64)) {
							final int i_8_ = class98_sub34.anInt4126;
							final int i_9_ = ((0x3fff & (Class64_Sub23.aClass370_3707.anIntArray3133[i_8_]) >> -86148882) + -Class272.anInt2038);
							final int i_10_ = (-aa_Sub2.anInt3562 + ((Class64_Sub23.aClass370_3707.anIntArray3133[i_8_]) & 0x3fff));
							final int i_11_ = -(i_3_ / 128) + 2 + 4 * i_9_;
							final int i_12_ = 2 + i_10_ * 4 - i_5_ / 128;
							Class164.method2522(
									i_11_,
									(Class64_Sub23.aClass370_3707.anIntArray3138[i_8_]),
									i_1_, var_aa, var_ha, i ^ ~0x7997ff75,
									class293, i_0_, i_12_);
						}
						for (int i_13_ = 0; ((i_13_ ^ 0xffffffff) > (Class98_Sub10_Sub7.anInt5577 ^ 0xffffffff)); i_13_++) {
							final int i_14_ = (-(i_3_ / 128) + 4
									* Class19.anIntArray3451[i_13_] + 2);
							final int i_15_ = (4 * Class6.anIntArray91[i_13_] + (2 + -(i_5_ / 128)));
							GameObjectDefinition class352 = (Class130.aClass302_1028
									.method3546(Class79.anIntArray603[i_13_],
											(byte) 119));
							if (class352.anIntArray2928 != null) {
								class352 = class352.method3852(
										(Class75.aClass140_584), (byte) -95);
								if (class352 == null
										|| class352.anInt2958 == -1) {
									continue;
								}
							}
							Class164.method2522(i_14_, (class352.anInt2958),
						...
						for (Class98_Sub45 class98_sub45 = ((Class98_Sub45) Class146.aClass377_1180
							...
							if ((i_16_ ^ 0xffffffff) == (Canvas_Sub1.anInt26 ^ 0xffffffff)) {
								...
								Class4.method173(i_1_, i_20_, i_0_, class293,
										var_aa, i_19_, (byte) -24,
										(Class93.aClass332Array3512[0]));
							}
						}
						for (int i_21_ = 0; Class150.anInt1211 > i_21_; i_21_++) {
							final Class98_Sub39 class98_sub39 = ((Class98_Sub39) (Class260.aClass377_3254
									.method3990(Class325.anIntArray2726[i_21_],
											i + -5)));
							if (class98_sub39 != null) {
								...
								if (class246_sub3_sub4_sub2_sub1
									...
									if (class141 != null
											&& class141.aBoolean1140
											&& (class141.aBoolean1116)) {
										final int i_22_ = ((((Class246_Sub3) class246_sub3_sub4_sub2_sub1).anInt5084) / 128 - i_3_ / 128);
										final int i_23_ = ((((Class246_Sub3) class246_sub3_sub4_sub2_sub1).anInt5079) / 128 + -(i_5_ / 128));
										if (class141.anInt1118 == -1) {
											Class4.method173(
													i_1_,
													i_23_,
													i_0_,
													...
													i_22_,
													(byte) -24,
													(Class93.aClass332Array3512[1]));
										} else {
											Class164.method2522(i_22_,
													(class141.anInt1118), i_1_,
													var_aa, var_ha,
													-2040004466, class293,
													i_0_, i_23_);
										}
						...
						for (int i_25_ = 0; (i_25_ ^ 0xffffffff) > (i_24_ ^ 0xffffffff); i_25_++) {
							...
							if (class246_sub3_sub4_sub2_sub2 != null
								...
								if (class246_sub3_sub4_sub2_sub2.aBoolean6534) {
									Class4.method173(i_1_, i_27_, i_0_,
											class293, var_aa, i_26_,
											(byte) -24,
											(Class93.aClass332Array3512[6]));
								} else if (bool) {
									Class4.method173(i_1_, i_27_, i_0_,
											class293, var_aa, i_26_,
											(byte) -24,
											(Class93.aClass332Array3512[3]));
								} else if (bool_29_) {
									Class4.method173(i_1_, i_27_, i_0_,
											class293, var_aa, i_26_,
											(byte) -24,
											(Class93.aClass332Array3512[5]));
								} else if (bool_31_) {
									Class4.method173(i_1_, i_27_, i_0_,
											class293, var_aa, i_26_,
											(byte) -24,
											(Class93.aClass332Array3512[4]));
								} else {
									Class4.method173(i_1_, i_27_, i_0_,
											class293, var_aa, i_26_,
											(byte) -24,
											(Class93.aClass332Array3512[2]));
								}
							}
						}
						final Class36[] class36s = Class104.aClass36Array903;
						for (int i_32_ = 0; ((i_32_ ^ 0xffffffff) > (class36s.length ^ 0xffffffff)); i_32_++) {
							final Class36 class36 = class36s[i_32_];
							if (class36 != null
									&& class36.anInt346 != 0
									&& ((Class215.anInt1614 % 20 ^ 0xffffffff) > -11)) {
								if ((class36.anInt346 ^ 0xffffffff) == -2) {
									final Class98_Sub39 class98_sub39 = ((Class98_Sub39) (Class260.aClass377_3254
											.method3990((class36.anInt345), -1)));
									if (class98_sub39 != null) {
										final Class246_Sub3_Sub4_Sub2_Sub1 class246_sub3_sub4_sub2_sub1 = (class98_sub39.aClass246_Sub3_Sub4_Sub2_Sub1_4187);
										final int i_33_ = ((((Class246_Sub3) class246_sub3_sub4_sub2_sub1).anInt5084) / 128 - i_3_ / 128);
										final int i_34_ = ((((Class246_Sub3) class246_sub3_sub4_sub2_sub1).anInt5079) / 128 - i_5_ / 128);
										Class98_Sub10_Sub29.method1090(
												class36.anInt341, var_aa,
												i_34_, i_33_, class293, i_1_,
												360000L, i_0_, 4);
									}
								}
								if (class36.anInt346 == 2) {
									final int i_35_ = (-(i_3_ / 128) + (class36.anInt338 / 128));
									final int i_36_ = (-(i_5_ / 128) + (class36.anInt347 / 128));
									long l = class36.anInt340 << 546406215;
									l *= l;
									Class98_Sub10_Sub29.method1090(
											class36.anInt341, var_aa, i_36_,
											i_35_, class293, i_1_, l, i_0_, 4);
								}
	...
	static final void method2697(final int i, final boolean bool) {
		try {
			if (i == -546) {
