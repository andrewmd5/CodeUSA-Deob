...
final class Class98_Sub10_Sub28 extends Class98_Sub10 {
	...
	public static void method1088(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "po.D(" + i + ')');
		}
	}
	...
	final int[] method990(final int i, final int i_37_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "po.G(" + i + ','
					+ i_37_ + ')');
		}
	}
	...
	final void method1001(final byte i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "po.I(" + i
						+ ')');
			}
			break;
		} while (false);
