...
final class Class98_Sub31_Sub4 extends Class98_Sub31 {
	...
	final synchronized void method1379(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.R(" + i + ')');
		}
	}
	...
	final synchronized void method1321(int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.M(" + i + ')');
		}
	}
	...
	final synchronized void method1380(final byte i,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("wb.P(" + i + ','
	...
	private final synchronized Class98_Sub46_Sub15 method1381(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.N(" + i + ')');
		}
	}
	...
	final synchronized double method1382(final boolean bool) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.S(" + bool
					+ ')');
		}
	}
	...
	final int method1326() {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.G(" + ')');
		}
	}
	...
	static final Class98_Sub46_Sub17 method1384(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.K(" + i + ')');
		}
	}
	...
	final Class98_Sub46_Sub15 method1385(final double d, final int i,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("wb.E(" + d + ','
					+ i + ',' + i_7_ + ')'));
		}
	}
	...
	static final void method1386(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.H(" + i + ')');
		}
	}
	...
	final synchronized int method1387(final boolean bool) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.C(" + bool
					+ ')');
		}
	}
	...
	private final synchronized void method1388(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.F(" + i + ')');
		}
	}
	...
	public static void method1389(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.J(" + i + ')');
		}
	}
	...
	static final int method1390(final int i, final int i_15_, final int i_16_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("wb.I(" + i + ','
					+ i_15_ + ',' + i_16_ + ',' + i_17_ + ')'));
		}
	}
	...
	final synchronized void method1391(final boolean bool, final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.L(" + bool
					+ ',' + i + ')');
		}
	}
	...
	final Class98_Sub31 method1322() {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.B(" + ')');
		}
	}
	...
	final void method1392(final int i, final int i_18_) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "wb.O(" + i
						+ ',' + i_18_ + ')');
			}
			break;
		} while (false);
	...
	final Class98_Sub31 method1327() {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.D(" + ')');
		}
	}
	...
	Class98_Sub31_Sub4(final int i) {
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "wb.<init>(" + i
					+ ')');
		}
	}
}
