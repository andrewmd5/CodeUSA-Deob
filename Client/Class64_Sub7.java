...
final class Class64_Sub7 extends Class64 {
	...
	static final char method576(final byte i, final byte i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ds.D(" + i + ','
					+ i_0_ + ')');
		}
	}
	...
	final void method550(final int i, final int i_3_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ds.B(" + i + ','
					+ i_3_ + ')');
		}
	}
	...
	final int method556(final int i, final int i_5_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ds.F(" + i + ','
					+ i_5_ + ')');
		}
	}
	...
	static final void method580(final ha var_ha, final int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ds.M("
					+ (var_ha != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
