...
final class Class69_Sub2 extends Class69 implements Interface2_Impl1 {
	...
	final int method704(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "va.Q(" + i + ')');
		}
	}
	...
	static final byte[] method705(final int i, final int i_0_, final byte[] is) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("va.P(" + i + ','
					+ i_0_ + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final Class53_Sub1 method706(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "va.O(" + i + ')');
		}
	}
	...
	public final boolean method71(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "va.N(" + i + ')');
		}
	}
	...
	public final boolean method74(final int i, final int i_2_, final int i_3_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("va.S(" + i + ','
					+ i_2_ + ',' + i_3_ + ')'));
		}
	}
	...
	public final void method72(final boolean bool) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "va.L(" + bool
					+ ')');
		}
	}
	...
	static final String method707(final byte[] is, final boolean bool) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("va.V("
					+ (is != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	public static void method708(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "va.R(" + i + ')');
		}
	}
	...
	public final boolean method73(final byte i, final int i_4_, final int i_5_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("va.T(" + i + ','
					+ i_4_ + ',' + i_5_ + ','
					+ (source != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public final int method2(final int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "va.E(" + i + ')');
		}
	}
	...
	public final Buffer method75(final boolean bool, final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "va.U(" + bool
					+ ',' + i + ')');
		}
	}
