...
class Node {
	...
	public static void method940(boolean bool) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "gda.AA(" + bool
					+ ')');
		}
	}
	...
	final boolean method941(byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "gda.T(" + i + ')');
		}
	}
	...
	final void method942(int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "gda.V(" + i + ')');
		}
	}
	...
	static final void method943(byte[] is, boolean bool, boolean bool_0_) {
		do {
			try {
				...
				Class30.method304(
						120,
						(((ByteBuffer) Class98_Sub10_Sub28.aClass98_Sub22_5705).incomingBytes));
				...
				throw Class64_Sub27.printError(runtimeexception, ("gda.U("
						+ (is != null ? "{...}" : "null") + ',' + bool + ','
						+ bool_0_ + ')'));
			}
			break;
	...
	static final boolean method944(int i, int i_2_, byte i_3_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("gda.W(" + i + ','
					+ i_2_ + ',' + i_3_ + ')'));
		}
	}
