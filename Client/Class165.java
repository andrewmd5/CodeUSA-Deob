...
final class Class165 {
	...
	static final void method2523(int i,
		...
		do {
			try {
				int i_0_ = (-Class215.anInt1614 + (((Entity) class246_sub3_sub4_sub2).anInt6390));
				int i_1_ = ((((Entity) class246_sub3_sub4_sub2).anInt6378) * 512 + 256 * class246_sub3_sub4_sub2
						.method3034(i ^ i));
				int i_2_ = ((((Entity) class246_sub3_sub4_sub2).anInt6347) * 512 + 256 * class246_sub3_sub4_sub2
						.method3034(0));
				...
				((Class246_Sub3) class246_sub3_sub4_sub2).anInt5084 += (-((Class246_Sub3) class246_sub3_sub4_sub2).anInt5084 + i_1_)
						/ i_0_;
				((Entity) class246_sub3_sub4_sub2).anInt6433 = 0;
				if (((((Entity) class246_sub3_sub4_sub2).anInt6407) ^ 0xffffffff) == -1)
					class246_sub3_sub4_sub2.method3042(8192, i + -20481);
				if ((((Entity) class246_sub3_sub4_sub2).anInt6407) == 1)
					class246_sub3_sub4_sub2.method3042(12288, -8193);
				if ((((Entity) class246_sub3_sub4_sub2).anInt6407) == 2)
					class246_sub3_sub4_sub2.method3042(0, -8193);
				if ((((Entity) class246_sub3_sub4_sub2).anInt6407) != 3)
					break;
	...
	public static void method2524(byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "kv.B(" + i + ')');
		}
	}
}
