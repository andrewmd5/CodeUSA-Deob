...
final class Class216 {
	...
	static final boolean method2793(final int i, final byte i_0_, final int i_1_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("nt.E(" + i + ','
					+ i_0_ + ',' + i_1_ + ')'));
		}
	}
	...
	static final void method2794(final byte i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "nt.D(" + i + ')');
		}
	}
	...
	static final void method2797(final int i, final int i_11_, final int i_12_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("nt.C(" + i + ','
					+ i_11_ + ',' + i_12_ + ',' + i_13_ + ')'));
		}
	}
	...
	public static void method2798(final int i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "nt.F(" + i
						+ ')');
			}
			break;
		} while (false);
