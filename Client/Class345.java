...
final class Class345 {
	...
	static final void method3824(final String string, final int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "v.B("
					+ (string != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
	...
	static final int method3825(int i, final int i_0_, final byte i_1_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("v.C(" + i + ','
					+ i_0_ + ',' + i_1_ + ')'));
		}
	}
	...
	protected final void finalize() throws Throwable {
		try {
			...
			throw Class64_Sub27
					.method667(runtimeexception, "v.finalize(" + ')');
		}
	}
	...
	Class345(final ha_Sub1 var_ha_Sub1, final long l, final int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("v.<init>("
