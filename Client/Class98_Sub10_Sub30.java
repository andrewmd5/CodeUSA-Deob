...
final class Class98_Sub10_Sub30 extends Class98_Sub10 {
	...
	final void method1001(final byte i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "qo.I(" + i
						+ ')');
			}
			break;
		} while (false);
	...
	final int[] method990(final int i, final int i_0_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "qo.G(" + i + ','
					+ i_0_ + ')');
		}
	}
	...
	final void method991(final int i, final ByteBuffer class98_sub22,
		...
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, ("qo.A(" + i
	...
	static final void method1093(final int i, final int i_10_,
		...
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, ("qo.B(" + i
						+ ',' + i_10_ + ',' + bool + ',' + i_11_ + ')'));
			}
			break;
		} while (false);
	...
	public static void method1094(final int i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "qo.D(" + i
						+ ')');
			}
			break;
		} while (false);
