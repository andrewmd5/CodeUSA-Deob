/* RSModelLoader - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class RSModelLoader extends Node {
	int anInt3838;
	int anInt3839;
	...
	public static void method975(final int i) {
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, "cd.B(" + i
						+ ')');
			}
			break;
		} while (false);
	...
	final boolean method976(final int i, final int i_0_, final int i_1_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("cd.E(" + i + ','
					+ i_0_ + ',' + i_1_ + ',' + i_2_ + ')'));
		}
	}
	...
	final boolean method977(final int i, final byte i_3_, final int i_4_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("cd.D(" + i + ','
					+ i_3_ + ',' + i_4_ + ')'));
		}
	}
	...
	final void method979(final int i, final int i_11_, final int i_12_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("cd.H(" + i + ','
					+ i_11_ + ',' + i_12_ + ','
					+ (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final boolean method980(final int i, final int i_13_, final int i_14_) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("cd.C(" + i + ','
					+ i_13_ + ',' + i_14_ + ')'));
		}
	}

	static final Model createModel(final int i, final int i_15_,
	...
	RSModelLoader(final int i, final int i_17_, final int i_18_,
	...
	final void method982(final int i, final int i_25_, final int i_26_,
		...
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, ("cd.A(" + i
						+ ',' + i_25_ + ',' + i_26_ + ','
						+ (is != null ? "{...}" : "null") + ')'));
			}
			break;
