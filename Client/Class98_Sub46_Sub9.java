...
final class Class98_Sub46_Sub9 extends Class98_Sub46 {
	...
	static final boolean method1554(final int i, final int i_2_, final int i_3_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("f.C(" + i + ','
					+ i_2_ + ',' + i_3_ + ')'));
		}
	}
	...
	final boolean method1555(final int i,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("f.A(" + i + ','
	...
	static final Class98_Sub11 method1556(final boolean bool) {
		try {
			...
			throw Class64_Sub27
					.method667(runtimeexception, "f.B(" + bool + ')');
		}
	}
	...
	final boolean method1557(final byte i,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("f.E(" + i + ','
					+ (class98_sub46_sub8 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method1558(final byte i, final Class98_Sub33 class98_sub33) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("f.G(" + i + ','
	...
	final int method1559(final int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "f.F(" + i + ')');
		}
	}
	...
	public static void method1560(final byte i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "f.M(" + i + ')');
		}
	}
	...
	static final void method1561(final ha var_ha, final int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "f.D("
					+ (var_ha != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
	...
	Class98_Sub46_Sub9(final String string) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "f.<init>("
					+ (string != null ? "{...}" : "null") + ')');
		}
	}
