...
class ByteBuffer extends Class98 {
	...
	final void method1181(final String string, final int i) {
		try {
			...
			aByteArray3992[position++] = (byte) 0;
			position += Class200.method2694(string, 0, string.length(),
					position, aByteArray3992, -28439);
			aByteArray3992[position++] = (byte) 0;
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ji.GB("
					+ (string != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	final void writeShortA(final int i, final byte i_1_) {
		try {
			aByteArray3992[position++] = (byte) (i >> 2119028456);
			if (i_1_ != 126) {
				writeLEInt(75, -5);
			}
			aByteArray3992[position++] = (byte) (128 + i);
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.RA(" + i + ','
					+ i_1_ + ')');
		}
	}
	...
	final int method1183(final int i) {
		try {
			position += 2;
			int i_2_ = (((aByteArray3992[-2 + position]) & 0xff) + ((aByteArray3992[position - 1]) << 1553290568 & 0xff00));
	...
	final byte method1184(final int i) {
		try {
			return (byte) ((aByteArray3992[position++]) - 128);
		} catch (final RuntimeException runtimeexception) {
	...
	final void writeInt(final int i, final int i_3_) {
		try {
			aByteArray3992[position++] = (byte) (i_3_ >> -1995948680);
			aByteArray3992[position++] = (byte) (i_3_ >> 1547612048);
			aByteArray3992[position++] = (byte) (i_3_ >> 1571862888);
			aByteArray3992[position++] = (byte) i_3_;
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.FA(" + i + ','
					+ i_3_ + ')');
		}
	}
	...
	final int readMediumInt(final int i) {
		try {
			position += 3;
			return (((aByteArray3992[-1 + position]) & 0xff)
					+ ((0xff & (aByteArray3992[-2 + position])) << 1155233704) + (((aByteArray3992[position
					+ -3]) & 0xff) << 251467472));
		} catch (final RuntimeException runtimeexception) {
	...
	final byte method1187(final byte i) {
		try {
			return (byte) -(aByteArray3992[position++]);
		} catch (final RuntimeException runtimeexception) {
	...
	final void method1188(final String string, final byte i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ji.BC("
					+ (string != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	final void method1190(final byte[] is, final boolean bool, final int i,
		...
		try {
			for (int i_7_ = i_6_; i_7_ < i_6_ + i; i_7_++) {
				is[i_7_] = (aByteArray3992[position++]);
			}
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ji.CA("
					+ (is != null ? "{...}" : "null") + ',' + bool + ',' + i
					+ ',' + i_6_ + ')'));
		}
	}
	...
	final byte readSignedByte(final byte i) {
		try {
			return (aByteArray3992[position++]); // read
			// byte
			// lol...
			// uhhhhh,
			// just
			...
			throw Class64_Sub27.method667(runtimeexception, "ji.NC(" + i + ')');
		}
	}
	...
	final int method1192(final byte i) {
		try {
			position += 3;
			return ((0xff & (aByteArray3992[-3 + position])) + (((0xff & (aByteArray3992[-2
					+ position])) << -1177345560) + (0xff0000 & ((aByteArray3992[position - 1]) << 587636880))));
		} catch (final RuntimeException runtimeexception) {
    ...
    public int readSpecialSmart() {
        int first = aByteArray3992[position] & 0xff;
        if (first < 128)
	...
	public int readIntSmart() {
		final int first = aByteArray3992[position];
		if (first >= 0) {
	...
	final int readInt1(final boolean bool) {
		try {
			position += 4;
			return (((aByteArray3992[-4 + position]) << -1188328504 & 0xff00)
					+ ((0xff0000 & ((aByteArray3992[position - 1]) << 340284016)) + (((aByteArray3992[position
							+ -2]) & 0xff) << -2077360904)) - -((aByteArray3992[-3
					+ position]) & 0xff));
		} catch (final RuntimeException runtimeexception) {
	...
	final void method1194(final int i, final int i_8_) {
		try {
			aByteArray3992[position++] = (byte) i;
		} catch (final RuntimeException runtimeexception) {
	...
	final void writeLEShort(final int i, final int i_10_) {
		try {
			aByteArray3992[position++] = (byte) i;
			aByteArray3992[position++] = (byte) (i >> -1001534936);
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.KA(" + i + ','
					+ i_10_ + ')');
		}
	}
	...
	final int method1196(final int i, final byte i_11_) {
		try {
			final int i_12_ = Class365.method3937(position, aByteArray3992, i,
					false);
			writeInt(1571862888, i_12_);
			return i_12_;
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.KB(" + i + ','
					+ i_11_ + ')');
		}
	}
	...
	final int readSmart() {
		try {
			final int i_13_ = 0xff & (aByteArray3992[position]);
			if (i_13_ < 128) {
				return readUnsignedByte((byte) -115);
			}
			return -32768 + readUnsignedShort((byte) 127);
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.R(" + ')');
		}
	}
	...
	final int method1198(final int i) {
		try {
			...
			int i_14_ = ((-128 + (aByteArray3992[position - 2]) & 0xff) + ((aByteArray3992[position
					+ -1]) << -1508488440 & 0xff00));
	...
	final void method1199(final int i, final boolean bool) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ji.QC(" + i + ','
					+ bool + ')');
		}
	}
	...
	final void method1200(final byte i, final int i_16_) {
		try {
			aByteArray3992[position++] = (byte) (i_16_ >> -968007800);
			aByteArray3992[position++] = (byte) i_16_;
			aByteArray3992[position++] = (byte) (i_16_ >> -922569928);
			aByteArray3992[position++] = (byte) (i_16_ >> -944199472);
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.MA(" + i + ','
					+ i_16_ + ')');
		}
	}
	...
	final void method1201(final int i) {
		do {
			try {
				if (aByteArray3992 != null) {
					Class129.method2228((byte) 75, aByteArray3992);
				}
				aByteArray3992 = null;
				if (i == 0) {
					break;
	...
	final int method1202(final byte i) {
		try {
			...
			return (((aByteArray3992[-3 + position]) << -401730296 & 0xff00)
					+ (((aByteArray3992[position + -2]) & 0xff) << 178467952) + (((0xff & (aByteArray3992[-1
					+ position])) << -688793032) + (0xff & (aByteArray3992[-4
					+ position]))));
		} catch (final RuntimeException runtimeexception) {
	...
	final int readUnsignedShort(final byte i) {
		try {
			position += 2;
			return (((aByteArray3992[position - 1]) & 0xff) + (((aByteArray3992[-2
					+ position]) & 0xff) << -1546530360));
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.CB(" + i + ')');
		}
	}
	...
	final String readString(final byte i) {
		...
		while (((aByteArray3992[position++]) ^ 0xffffffff) != -1) {
			/* empty */
		}
	...
	final void method1205(final BigInteger biginteger, final boolean bool,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ji.IA("
	...
	final void writeByteS(final int i, final int i_24_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("ji.HA(" + i
						+ ',' + i_24_ + ')'));
			}
			break;
		} while (false);
	...
	final void method1207(final byte i, final int i_25_) {
		try {
			aByteArray3992[position - i_25_ + -2] = (byte) (i_25_ >> 1804543080);
			if (i != 90) {
				readUnsignedByte((byte) -108);
			}
			aByteArray3992[-1 + (-i_25_ + position)] = (byte) i_25_;
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.CC(" + i + ','
					+ i_25_ + ')');
		}
	}
	...
	final int readInt2(final int i) {
		try {
			...
			return (((aByteArray3992[-2 + position]) & 0xff)
					+ (((aByteArray3992[position + -4]) & 0xff) << 1981066736) + ((((aByteArray3992[-3
					+ position]) & 0xff) << -1310222600) + ((0xff & (aByteArray3992[position - 1])) << 1074766536)));
		} catch (final RuntimeException runtimeexception) {
	...
	final boolean method1210(final int i) {
		try {
			position -= 4;
			final int i_29_ = Class365.method3937(position, aByteArray3992, 0,
					false);
	...
	final void method1211(final byte i, final int i_31_) {
		try {
			if (i > 79) {
				aByteArray3992[-i_31_ + (position - 1)] = (byte) i_31_;
			}
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.HB(" + i + ','
					+ i_31_ + ')');
		}
	}
	...
	final int readShortA(final int i) {
		try {
			...
			return ((0xff & (aByteArray3992[position - 1]) - 128) + (0xff00 & ((aByteArray3992[position
					+ -2]) << -834637528)));
		} catch (final RuntimeException runtimeexception) {
	...
	final void method1213(final int i, final long l, int i_32_) {
		try {
			...
			for (int i_33_ = 8 * i_32_; i_33_ >= 0; i_33_ -= 8) {
				aByteArray3992[position++] = (byte) (int) (l >> i_33_);
			}
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ji.S(" + i + ','
					+ l + ',' + i_32_ + ')'));
		}
	}
	...
	final int readUShort(final boolean bool) { // h
		try {
			...
			int i = ((0xff00 & ((aByteArray3992[position + -2]) << 1357336488)) - -((aByteArray3992[position
					+ -1]) & 0xff));
			if (i > 32767) {
				i -= 65536;
			}
	...
	public int readCustomUShort() {
		position += 2;
		final int i = (aByteArray3992[position - 1] & 0xff)
				+ ((aByteArray3992[position - 2] & 0xff) << 8);
		if (i == 65535) {
			return -1;
		}
		return i;
	...
	final void method1215(final int[] is, final int i, final int i_34_,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ji.AB("
	...
	final void method1217(final byte[] is, final int i, final int i_44_,
		...
		try {
			...
			for (/**/; i + i_45_ > i_46_; i_46_++) {
				aByteArray3992[position++] = is[i_46_];
			}
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ji.DB("
	...
	final void method1218(final int i, final int i_47_) {
		try {
			aByteArray3992[position++] = (byte) i;
			aByteArray3992[position++] = (byte) (i >> 1489446952);
			if (i_47_ != 1489446952) {
				aByteArray3992 = null;
			}
			aByteArray3992[position++] = (byte) (i >> 182207856);
			aByteArray3992[position++] = (byte) (i >> -43371176);
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.MC(" + i + ','
					+ i_47_ + ')');
		}
	}
	...
	final int readInt(final int i) {
		try {
			position += 4;
			return ((0xff & (aByteArray3992[-1 + position]))
					+ ((0xff0000 & ((aByteArray3992[-3 + position]) << 326096944)) + ((0xff & (aByteArray3992[-4
							+ position])) << 1206151768)) + ((aByteArray3992[-2
	...
	final int readLEShortA(final byte i) {
		try {
			position += 2;
			return ((((aByteArray3992[position - 1]) & 0xff) << -1492087128) + (0xff & (aByteArray3992[-2
					+ position]) - 128));
		} catch (final RuntimeException runtimeexception) {
	...
	final void method1221(final int i, final long l) {
		try {
			aByteArray3992[position++] = (byte) (int) (l >> 47442488);
			if (i > -49) {
				position = -23;
			}
			aByteArray3992[position++] = (byte) (int) (l >> 1602810288);
			aByteArray3992[position++] = (byte) (int) (l >> 140118760);
			aByteArray3992[position++] = (byte) (int) (l >> 1658586912);
			aByteArray3992[position++] = (byte) (int) (l >> -1173783976);
			aByteArray3992[position++] = (byte) (int) (l >> -1213337456);
			aByteArray3992[position++] = (byte) (int) (l >> 170858184);
			aByteArray3992[position++] = (byte) (int) l;
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.JB(" + i + ','
					+ l + ')');
		}
	}
	...
	final String method1222(final int i) {
		try {
			if (((aByteArray3992[position]) ^ 0xffffffff) == i) {
				position++;
				return null;
			}
	...
	final String method1223(final int i) {
		try {
			final byte i_49_ = (aByteArray3992[position++]);
	...
	final void writeShort(final int i, final int i_52_) {
		try {
			aByteArray3992[position++] = (byte) (i >> 737932552);
			aByteArray3992[position++] = (byte) i;
		} catch (final RuntimeException runtimeexception) {
	...
	final void method1225(final int i, final int i_53_) {
		do {
			try {
				aByteArray3992[position++] = (byte) (i_53_ >> 1668051632);
				aByteArray3992[position++] = (byte) (i_53_ >> 831021000);
				aByteArray3992[position++] = (byte) i_53_;
				if (i == -24472) {
					break;
					// readInt(46);
				}
			} catch (final RuntimeException runtimeexception) {
				throw Class64_Sub27.method667(runtimeexception, ("ji.RB(" + i
						+ ',' + i_53_ + ')'));
			}
			break;
		} while (false);
	...
	final int readByteC(final byte i) {
		try {
			return (-(aByteArray3992[position++]) & 0xff);
		} catch (final RuntimeException runtimeexception) {
	...
	final int method1227(final byte i) {
		try {
			...
			position += 3;
			int i_55_ = ((((aByteArray3992[-2 + position]) & 0xff) << -1482393368) + (((aByteArray3992[position - 3]) << 1099514736 & 0xff0000) + ((aByteArray3992[-1
					+ position]) & 0xff)));
	...
	final int readShort1(final byte i) {
		try {
			position += 2;
			return ((0xff & (aByteArray3992[-2 + position])) + (((aByteArray3992[-1
	...
	final int readUnsignedByte(final byte i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ji.OA(" + i + ')');
		}
	}

	final int readByteS(final int i) {
		try {
			return (128 + -(aByteArray3992[position++]) & 0xff);
		} catch (final RuntimeException runtimeexception) {
	...
	final void method1231(final int i, final byte i_59_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ji.Q(" + i + ','
					+ i_59_ + ')');
		}
	}
	...
	final void method1232(final int i, final byte i_61_) {
		do {
			try {
				aByteArray3992[position++] = (byte) (i >> 1586241040);
				aByteArray3992[position++] = (byte) (i >> 1689622712);
				aByteArray3992[position++] = (byte) i;
				aByteArray3992[position++] = (byte) (i >> 1259248840);
				if (i_61_ > 74) {
					break;
				}
				anInt3994 = 115;
			} catch (final RuntimeException runtimeexception) {
				throw Class64_Sub27.method667(runtimeexception, ("ji.IB(" + i
						+ ',' + i_61_ + ')'));
			}
			break;
		} while (false);
	...
	final void method1233(final byte i, final int i_62_) {
		try {
			aByteArray3992[-4 + (-i_62_ + position)] = (byte) (i_62_ >> 749084632);
			if (i > -69) {
				method1190(null, false, -107, -119);
			}
			aByteArray3992[-3 + (-i_62_ + position)] = (byte) (i_62_ >> -1146031696);
			aByteArray3992[-i_62_ + position + -2] = (byte) (i_62_ >> -2096973304);
			aByteArray3992[-i_62_ + (position + -1)] = (byte) i_62_;
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.O(" + i + ','
					+ i_62_ + ')');
		}
	}
	...
	final void method1235(final boolean bool, final int[] is, final int i,
		...
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("ji.AC("
						+ bool + ',' + (is != null ? "{...}" : "null") + ','
						+ i + ',' + i_63_ + ')'));
			}
			break;
	...
	final int readByteA(final boolean bool) {
		try {
			...
			return 0xff & (aByteArray3992[position++]) - 128;
		} catch (final RuntimeException runtimeexception) {
	...
	final void method1237(final int i, final int i_72_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ji.EC(" + i + ','
					+ i_72_ + ')');
		}
	}
	...
	final void writeLEShortA(final int i, final int i_73_) {
		try {
			aByteArray3992[position++] = (byte) (i_73_ + i);
			aByteArray3992[position++] = (byte) (i >> 806931912);
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.IC(" + i + ','
					+ i_73_ + ')');
		}
	}
	...
	final int method1239(final int i) {
		try {
			final int i_74_ = 0xff & (aByteArray3992[position]);
	...
	final int method1240(final byte i) {
		try {
			...
			int i_76_ = (aByteArray3992[position++]);
			int i_77_ = 0;
			for (/**/; i_76_ < 0; i_76_ = (aByteArray3992[position++])) {
	...
	static final boolean method1241(final boolean bool, final int i,
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ji.L(" + bool
					+ ',' + i + ',' + i_78_ + ')'));
		}
	}
	...
	final int method1242(final int i) {// k
		try {
			position += 2;
			int i_79_ = (((aByteArray3992[-1 + position]) - 128 & 0xff) + (0xff00 & ((aByteArray3992[-2
					+ position]) << 365122312)));
	...
	final void method1244(final int i, final byte i_80_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ji.VB(" + i + ','
					+ i_80_ + ')');
		}
	}
	...
	final void writeLEInt(final int i, final int i_81_) {
		try {
			...
			aByteArray3992[position++] = (byte) (i >> -965600312);
			aByteArray3992[position++] = (byte) (i >> 534653328);
			aByteArray3992[position++] = (byte) (i >> 1046032984);
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.TB(" + i + ','
					+ i_81_ + ')');
		}
	}
	...
	final void method1247(final int i, final int i_83_) {
		try {
			...
			aByteArray3992[position++] = (byte) (i >> 1291747880);
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.DA(" + i + ','
					+ i_83_ + ')');
		}
	}
	...
	final long method1248(int i, final boolean bool) {
		try {
			...
			long l = 0L;
			for (/**/; i_84_ >= 0; i_84_ -= 8) {
				l |= ((aByteArray3992[position++]) & 0xffL) << i_84_;
			}
			return l;
		} catch (final RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ji.BB(" + i + ','
					+ bool + ')');
		}
	}
	...
	final int readIntReverse(final boolean bool) {
		try {
			position += 4;
			return (((aByteArray3992[-4 + position]) & 0xff)
					+ ((0xff & (aByteArray3992[-2 + position])) << -1498293360) + ((((aByteArray3992[-1
					+ position]) & 0xff) << 1899061624) - -((0xff & (aByteArray3992[-3
					+ position])) << 279902248)));
		} catch (final RuntimeException runtimeexception) {
	...
	ByteBuffer(final int i) {
		try {
			aByteArray3992 = Class129.method2225(false, i);
			position = 0;
		} catch (final RuntimeException runtimeexception) {
	...
	ByteBuffer(final byte[] is) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ji.<init>("
					+ (is != null ? "{...}" : "null") + ')');
		}
	}
		...
		do {
			try {
				for (int i_86_ = i_85_ + i + -1; (i_86_ ^ 0xffffffff) <= (i ^ 0xffffffff); i_86_--) {
					is[i_86_] = (byte) (-128 + (aByteArray3992[position++]));
				}
				if (bool == false) {
					break;
				}
				...
				throw Class64_Sub27.method667(runtimeexception, ("ji.NA(" + i
						+ ',' + i_85_ + ',' + bool + ','
						+ (is != null ? "{...}" : "null") + ')'));
			}
			break;
