/* AbstractModel - Decompiled by JODE
...
abstract class AbstractModel {
	...
	final void method2321(int i, int i_0_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("ka.TB(" + i + ','
					+ i_0_ + ','
	...
	final void method2323(int i, int i_14_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("ka.WB(" + i + ','
					+ i_14_ + ','
					+ (class98_sub46_sub16 != null ? "{...}" : "null") + ','
					+ i_15_ + ',' + i_16_ + ','
	...
	public static void method2328(int i) {
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, "ka.QB(" + i + ')');
		}
	}
	...
	abstract void method2332(AbstractModel class146_60_, int i, int i_61_,
	...
	private final void method2334(int i, boolean bool, int i_66_, int i_67_,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("ka.RB(" + i + ','
	...
	final void method2336(int i, int i_110_, s var_s, int i_111_, int i_112_,
		...
		do {
			try {
				...
				throw Class64_Sub27.printError(runtimeexception, ("ka.AC(" + i
						+ ',' + i_110_ + ','
	...
	final void method2338(int i, Class98_Sub46_Sub16 class98_sub46_sub16,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("ka.SB(" + i + ','
					+ (class98_sub46_sub16 != null ? "{...}" : "null") + ','
					+ i_143_ + ','
	...
	final void method2340(Class98_Sub46_Sub16 class98_sub46_sub16, int i,
		...
		try {
			...
			throw Class64_Sub27.printError(runtimeexception, ("ka.VB("
					+ (class98_sub46_sub16 != null ? "{...}" : "null") + ','
					+ i + ',' + i_156_ + ')'));
		}
	}
	...
	abstract AbstractModel method2341(byte i, int i_170_, boolean bool);
